...
sale_campaign_detail_ga = api_views.GoogleAnalyticsViewSet.as_view()
...
urlpatterns = format_suffix_patterns([
    ...
    path('sale/campaigns/<int:pk>/google_analytics/', sale_campaign_detail_ga, name='salecampaign-detail-google-analytics'),
